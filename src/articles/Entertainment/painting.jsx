...
const PAINTINGS = [
  {
    ...
    items: [
      ...
      ["The Ambassadors", "Hans Holbein the Younger · 1533", undefined, "Chân dung hai nhà ngoại giao Pháp đứng cạnh bàn đầy dụng cụ khoa học, âm nhạc, với một hình thù méo mó lạ mắt vắt chéo dưới chân họ. Chỉ khi nhìn từ một góc chéo đặc biệt, hình thù đó mới hiện rõ thành một đầu lâu — kỹ thuật phối cảnh biến dạng (anamorphosis) nhắc nhở về cái chết giữa vinh hoa trần thế."],
      ["Venus of Urbino", "Titian · 1538", undefined, "Một phụ nữ khỏa thân nằm nghiêng trên giường, ánh mắt nhìn thẳng người xem một cách tự tin thay vì e ấp như các Venus cổ điển trước đó. Bố cục táo bạo này ảnh hưởng trực tiếp đến vô số tranh khỏa thân nằm sau này, trong đó nổi tiếng nhất là \"Olympia\" của Manet ba thế kỷ sau."],
      ["The Tower of Babel", "Pieter Bruegel the Elder · 1563", undefined, "Ngọn tháp khổng lồ dựa theo tích Kinh Thánh về loài người muốn xây công trình chạm tới trời rồi bị Chúa làm xáo trộn ngôn ngữ để chia rẽ, được vẽ với độ chi tiết kiến trúc và hàng nghìn nhân vật nhỏ li ti. Tác phẩm vừa là câu chuyện tôn giáo vừa ngụ ý phê phán sự kiêu ngạo và tham vọng quá độ của con người."],
      ["Hunters in the Snow", "Pieter Bruegel the Elder · 1565", undefined, "Cảnh nhóm thợ săn cùng đàn chó mệt mỏi trở về làng qua một thung lũng phủ tuyết trắng xóa, phía xa là dân làng trượt băng trên mặt hồ đóng đá. Thuộc loạt tranh \"Các Tháng\" mô tả nhịp sống nông thôn theo mùa, tác phẩm là một trong những cảnh tuyết nổi tiếng và có ảnh hưởng nhất lịch sử hội họa phương Tây."],
      ["Las Hilanderas (The Spinners)", "Diego Velázquez · 1657", undefined, "Bề ngoài là cảnh các nữ công nhân kéo sợi trong xưởng dệt, nhưng lớp hậu cảnh phía sau lại tái hiện thần thoại về cuộc thi dệt vải giữa nữ thần Athena và người phàm Arachne. Sự lồng ghép giữa đời thường và thần thoại trong cùng một bố cục là minh chứng cho kỹ thuật kể chuyện đa tầng bậc thầy của Velázquez."],
    ],
  },
  {
    ...
    items: [
      ...
      ["Olympia", "Édouard Manet · 1863", undefined, "Một phụ nữ khỏa thân nằm nhìn thẳng người xem không chút e dè, được một người hầu da đen mang hoa đến tặng — bố cục gợi nhớ \"Venus of Urbino\" của Titian nhưng thay thần thoại bằng hiện thực trần trụi của một kỹ nữ Paris đương thời. Tác phẩm gây scandal dữ dội tại Salon Paris 1865, được xem là bước ngoặt mở đường cho hội họa hiện đại."],
      ["Le Déjeuner sur l'herbe", "Édouard Manet · 1862–1863", undefined, "Cảnh một phụ nữ khỏa thân ngồi picnic cùng hai người đàn ông ăn mặc chỉnh tề giữa khung cảnh đồng quê, một sự kết hợp phi lý và táo bạo so với chuẩn mực đạo đức đương thời. Bị Salon Paris từ chối triển lãm, tác phẩm sau đó trưng bày tại \"Salon des Refusés\" (Triển lãm của những người bị từ chối) và trở thành biểu tượng cho tinh thần nổi loạn của hội họa hiện đại."],
      ["The Dance Class", "Edgar Degas · 1874", undefined, "Cảnh hậu trường một lớp học múa ballet với các vũ công trẻ đang khởi động, nghỉ ngơi dưới sự giám sát của một giáo viên già, thay vì cảnh biểu diễn hào nhoáng trên sân khấu. Degas nổi tiếng với việc chọn những góc nhìn bất ngờ, cắt cúp táo bạo như ảnh chụp nhanh, khác hẳn bố cục cân đối truyền thống."],
      ["Irises", "Vincent van Gogh · 1889", undefined, "Tĩnh vật khóm hoa diên vĩ tím rực rỡ trên nền đất và cỏ, được Van Gogh vẽ trong tuần đầu tiên tại bệnh viện tâm thần Saint-Rémy, ngay trước khi ông vẽ \"The Starry Night\". Ông mô tả việc vẽ tranh này giúp mình \"giữ được sự cân bằng\" trong giai đoạn khủng hoảng tinh thần nặng nề."],
      ["Woman with a Parasol", "Claude Monet · 1875", undefined, "Chân dung vợ và con trai Monet đứng trên đồi cỏ dưới bầu trời nhiều mây, gió thổi tung chiếc dù và tà váy, được nhìn từ góc thấp khiến hai nhân vật nổi bật giữa nền trời. Tác phẩm là một trong những ví dụ sinh động nhất về khả năng nắm bắt chuyển động tức thời của gió và ánh sáng trong hội họa Ấn tượng."],
    ],
  },
  {
    ...
    items: [
      ...
      ["No. 5, 1948", "Jackson Pollock · 1948", undefined, "Một tấm ván ép phủ kín những vệt sơn nhỏ giọt, văng, đổ đan xen hỗn loạn — không hình khối, không tâm điểm rõ ràng — vẽ bằng cách trải toan xuống sàn và di chuyển quanh nó thay vì dùng giá vẽ truyền thống. Tác phẩm tiêu biểu cho kỹ thuật \"action painting\" của Pollock, biểu tượng hàng đầu của trường phái Biểu hiện Trừu tượng Mỹ."],
      ["The Two Fridas", "Frida Kahlo · 1939", undefined, "Hai phiên bản của chính Frida Kahlo ngồi cạnh nhau nắm tay, trái tim lộ ra ngoài và nối với nhau bằng một mạch máu, vẽ ngay sau khi bà ly hôn họa sĩ Diego Rivera. Một Frida mặc trang phục châu Âu tượng trưng cho phần bị chồng ruồng bỏ, một Frida mặc trang phục Mexico truyền thống tượng trưng cho bản sắc mà bà giữ vững."],
      ["Christina's World", "Andrew Wyeth · 1948", undefined, "Một phụ nữ mặc váy hồng ngồi giữa cánh đồng cỏ khô, nhìn về một ngôi nhà nông trại xa xa trên đỉnh đồi, tư thế gợi cảm giác vừa yên bình vừa bất an khó gọi tên. Người mẫu Christina Olson mắc chứng bệnh khiến bà không thể đi lại, và Wyeth vẽ bà đang tự lê mình về nhà — chi tiết khiến bức tranh trở nên ám ảnh hơn nhiều so với vẻ ngoài êm đềm."],
      ["Whistler's Mother", "James McNeill Whistler · 1871", undefined, "Chân dung mẹ họa sĩ ngồi nghiêng, mặc đồ đen giản dị trên nền tường xám, với tên gọi chính thức khô khan \"Arrangement in Grey and Black No. 1\" nhấn mạnh Whistler quan tâm đến bố cục màu sắc hơn là kể chuyện tình cảm. Dù vậy, tác phẩm trở thành một trong những biểu tượng văn hóa đại chúng Mỹ về tình mẫu tử, được nhại lại vô số lần."],
      ["Broadway Boogie Woogie", "Piet Mondrian · 1942–1943", undefined, "Tác phẩm trừu tượng cuối đời của Mondrian, thay các đường kẻ đen đặc trưng bằng những dải ô vuông màu vàng, đỏ, xanh nhấp nháy, lấy cảm hứng từ ánh đèn thành phố New York và nhịp điệu nhạc boogie-woogie ông yêu thích. Đây là bước chuyển mình năng động, rộn ràng hơn hẳn phong cách tĩnh lặng trước đó của ông."],
    ],
  },
  {
    ...
    items: [
      ...
      ["Vườn Xuân Trung Nam Bắc", "Nguyễn Gia Trí · 1969–1989", undefined, "Bộ tranh sơn mài khổ lớn gồm nhiều tấm ghép, khắc họa cảnh xuân với thiếu nữ ba miền Bắc-Trung-Nam trong trang phục truyền thống giữa khung cảnh hoa lá rực rỡ dát vàng, dát bạc. Nguyễn Gia Trí — người được xem là bậc thầy khai sinh chất liệu sơn mài hiện đại Việt Nam — mất hai thập kỷ để hoàn thiện tác phẩm, nay là Bảo vật quốc gia."],
      ["Phú Nhạc Tam Thập Lục Cảnh — Xích Phú (Gió Nam Bầu Trời Quang)", "Katsushika Hokusai · ~1830–1832", undefined, "Một bản khắc gỗ khác trong loạt \"Ba mươi sáu cảnh núi Phú Sĩ\" cùng với \"The Great Wave\", khắc họa ngọn núi nhuộm đỏ dưới nắng sớm mùa hạ trên nền trời xanh và mây trắng. Với bố cục tối giản, gần như trừu tượng, tác phẩm thường được xem là bức chân dung thuần khiết và trang nghiêm nhất về núi Phú Sĩ trong nghệ thuật Nhật Bản."],
    ],
  },
];
...
const MOOD_TAGS = {
  ...
  "The Ambassadors": ["mindbend", "culture"],
  "Venus of Urbino": ["romance", "culture"],
  "The Tower of Babel": ["culture", "mindbend"],
  "Hunters in the Snow": ["solitude", "culture"],
  "Las Hilanderas (The Spinners)": ["culture", "mindbend"],
  ...
  "Olympia": ["culture", "thrill"],
  "Le Déjeuner sur l'herbe": ["culture", "fun"],
  "The Dance Class": ["culture", "cozy"],
  "Irises": ["heal", "cozy"],
  "Woman with a Parasol": ["adventure", "cozy"],
  ...
  "No. 5, 1948": ["mindbend", "thrill"],
  "The Two Fridas": ["sad", "solitude"],
  "Christina's World": ["solitude", "sad"],
  "Whistler's Mother": ["culture", "cozy"],
  "Broadway Boogie Woogie": ["fun", "mindbend"],
  ...
  "Vườn Xuân Trung Nam Bắc": ["culture", "heartwarming"],
  "Phú Nhạc Tam Thập Lục Cảnh — Xích Phú (Gió Nam Bầu Trời Quang)": ["heal", "culture"],
};
